    ...
    <div className="max-w-3xl mx-auto space-y-8 pb-12">
      ...
      <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm dark:bg-slate-900 dark:border-slate-800">
          ...
          <form onSubmit={handleUpdateProfile} className="space-y-4 max-w-md">
              <div>
                  ...
                  <input disabled value={user?.email || ''} className="w-full rounded-lg border border-slate-200 bg-slate-50 px-3 py-2 text-sm text-slate-500 cursor-not-allowed dark:bg-slate-800 dark:border-slate-700" />
              </div>
              ...
              <div>
                  ...
                  <input 
                    ...
                    className="w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 focus:border-indigo-500 focus:outline-none dark:bg-slate-950 dark:border-slate-700 dark:text-white"
                  />
              </div>
              ...
              <div className="flex items-center gap-4">
                  ...
                  {successMsg && (
                      <span className="text-xs font-medium text-green-600 flex items-center gap-1 animate-in fade-in">
                          <CheckCircle className="h-3 w-3" /> {successMsg}
                      </span>
                  )}
              </div>
          </form>
      ...
      <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm dark:bg-slate-900 dark:border-slate-800">
          ...
          <div className="flex items-center justify-between">
              ...
              <button 
                ...
                className="px-4 py-2 text-sm font-medium text-slate-700 border border-slate-300 rounded-lg hover:bg-slate-50 dark:text-slate-300 dark:border-slate-700 dark:hover:bg-slate-800"
              >
                  Reset Password
              </button>
          </div>
      ...
      <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm dark:bg-slate-900 dark:border-slate-800">
          ...
          <div className="flex items-center justify-between">
              <div className="text-sm text-slate-600 dark:text-slate-400 max-w-md">
                  Download a complete backup of your portfolios, transactions, and watchlist as a JSON file.
              </div>
              <button 
      ...
      <div className="rounded-xl border border-red-200 bg-red-50 p-6 dark:bg-red-900/10 dark:border-red-900/30">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div className="text-sm text-red-600/80 dark:text-red-400/80 max-w-md">
                  Permanently delete all your transaction data and portfolios. This action cannot be undone.
              </div>
              <button 
                onClick={handleResetAccount}
                className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-red-600 rounded-lg hover:bg-red-700 whitespace-nowrap"
              >
