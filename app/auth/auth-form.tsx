  ...
  return (
    <div className="w-full">
      ...
      <button
        ...
        disabled={loading}
        className="flex w-full items-center justify-center gap-3 rounded-lg bg-white py-2.5 text-sm font-semibold text-slate-700 hover:bg-slate-100 disabled:opacity-70 shadow-md transition-all mb-6"
      >
        {loading ? (
      ...
      <div className="relative mb-6">
        ...
        <div className="relative flex justify-center text-xs uppercase">
          <span className="bg-transparent px-2 text-slate-300">Or with email</span>
        </div>
      </div>
      ...
      <form onSubmit={handleEmailAuth} className="space-y-4">
        <div>
          ...
          <input
            ...
            required
            className="w-full rounded-lg border border-white/30 bg-white/10 px-3 py-2.5 text-sm text-white placeholder-slate-300 focus:border-indigo-400 focus:outline-none focus:ring-1 focus:ring-indigo-400 transition-all backdrop-blur-sm"
